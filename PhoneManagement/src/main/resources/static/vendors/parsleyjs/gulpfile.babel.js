...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../index1.html"><<< back to documentation</a>'))
...
function writeVersion() {
  return gulp.src(['index1.html', 'doc/download.html', 'README.md'], { base: "./" })
